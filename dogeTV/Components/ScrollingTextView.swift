...
//  dogeTV
//
//  Created by Popeye Lau on 2019/5/4.
//  Copyright https://gist.github.com/NicholasBellucci/b5e9d31c47f335c36aa043f5f39eedb2
...
open class ScrollingTextView: NSView {
    ...
    private lazy var textFontAttributes: [NSAttributedString.Key: Any] = {
        return [NSAttributedString.Key.font: font ?? NSFont.systemFont(ofSize: 12)]
    }()
    ...
    open func setup(string: String) {
        ...
        stringSize = text?.size(withAttributes: textFontAttributes) ?? NSSize(width: 0, height: 17)
