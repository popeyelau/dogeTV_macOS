...
class SearchBarView: NSView, LoadableNib {
    ...
    func setup() {
        ...
        layer?.backgroundColor = NSColor(srgbRed:0.23, green:0.24, blue:0.25, alpha:1.00).cgColor
        textField.focusRingType = .none
        textField.backgroundColor = .clear
        let attr = NSAttributedString(string: "搜索电影/演员/导演", attributes: [.foregroundColor: NSColor.lightGray, .font: textField.font!])
